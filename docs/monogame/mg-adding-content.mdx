---
id: mg-adding-content
title: Adding Content
---

<!---
import Image from '@theme/IdealImage';
import thumbnail from './assets/NinjaFrogFall.png';
-->
...
If you haven't already, you'll need to install the MGCB Editor for managing your content. For details on getting access to this tool, see the installation instructions here.
...
<!--<img src=".assets/NinjaFrogFall.png" alt="ninjafrog" style="width:64px;"/>-->

![NinjaFrogFall](.assets/NinjaFrogFall.png)
...
If you do not see the mgcb-editor-wpf option when you right-click and select Open With, then please review the Tools documentation for installing the MGCB Editor tool for your operating system.
